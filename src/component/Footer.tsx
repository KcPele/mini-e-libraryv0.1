      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
          ...
          <p className="mb-6 text-base text-white/60 md:text-lg">
            ...
            ratione quo neque eius odit dolorem nisi vero id placeat! Qui rerum
            nisi doloribus incidunt vel provident ad architecto ea aut!
          </p>
          ...
          <p className="max-w-md mb-10 text-xs tracking-wide text-white/80 sm:text-sm sm:mx-auto md:mb-16">
